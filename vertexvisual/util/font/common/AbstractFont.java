package dev.sxmurxy.vertexvisual.util.font.common;
...
import dev.sxmurxy.vertexvisual.util.font.TextureHelper;
import dev.sxmurxy.vertexvisual.util.font.Wrapper;
...
public abstract class AbstractFont implements Wrapper {
	...
	public static final Font getFont(String fileName, int style, int size) {
		String path = VertexVisualMod.FONT_DIR.concat(fileName);
		Font font = null;
		
		try {
			font = Font.createFont(Font.TRUETYPE_FONT, VertexVisualMod.class.getResourceAsStream(path))
