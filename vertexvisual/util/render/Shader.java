...
public class Shader implements Wrapper {
	...
	public static String getShaderSource(String fileName) {
		String source = "";
		BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(VertexVisualMod.class
				.getResourceAsStream("/assets/" + VertexVisualMod.MOD_ID + "/shaders/" + fileName)));
